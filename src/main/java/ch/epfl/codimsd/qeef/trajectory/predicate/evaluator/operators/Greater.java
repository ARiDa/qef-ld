...
public class Greater extends BinaryOperator {
    ...
    /**
     * 
     * Verifica se o valor definido por leftValue � maior que rightValue.
     ...
     *
     * @return Boolean. True se leftValue maior que rightValue, false caso contr�rio.
     *  
