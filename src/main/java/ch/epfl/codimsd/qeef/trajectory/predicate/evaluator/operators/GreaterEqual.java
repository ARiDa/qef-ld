...
/**
 * Define opera��o maior igual que (>=).
 * 
...
public class GreaterEqual extends BinaryOperator {
    ...
    /**
     * 
     * Verifica se o valor definido por leftValue � maior igual que rightValue.
     ...
     *
     * @return Boolean. True se leftValue maior igual que rightValue, false caso contr�rio.
     *
