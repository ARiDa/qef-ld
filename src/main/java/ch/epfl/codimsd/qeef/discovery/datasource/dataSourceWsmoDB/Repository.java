...
public class Repository {
	...
	static Query query;
	static ConnectionObject connection;

	public Repository(Query _query, ConnectionObject _connection) {
	...
	public String excecuteQuery(){
		...
		String answer = conn.read(queryFinal,"xml");
		conn.close();
	...
	static String cond2(String cond1){
		...
		// int cond1_lastslashIndex = cond1.lastIndexOf("/");
	...
	static String cond3(String cond2){
	...
	static String proj2(String proj1){
