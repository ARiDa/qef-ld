...
public class Less extends BinaryOperator {
    ...
    /**
     * 
     * Verifica se o valor definido por leftValue � menor que rightValue.
     ...
     *
	 * @return. Boolean True se leftValue menor que rightValue, false caso contr�rio.
     *
